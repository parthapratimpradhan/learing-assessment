...
import com.learing.forall.repo.StaffRepository;
import com.learing.forall.repo.StudentRepository;

@SpringBootApplication
public class LearingAssessmentApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(LearingAssessmentApplication.class, args);
	}
